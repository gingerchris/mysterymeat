...
templates["item_2x2"] = new Hogan.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div class=\"project__item--2x2 project__item--");t.b(t.v(t.d("item.side",c,p,0)));t.b("\" data-pos=\"");t.b(t.v(t.d("item.side",c,p,0)));t.b("_");t.b(t.v(t.d("item.pos",c,p,0)));t.b("\">");t.b("\n" + i);t.b("    <img src=\"");t.b(t.v(t.d("item.path",c,p,0)));t.b("\" alt=\"");t.b(t.v(t.d("item.alt",c,p,0)));t.b("\" />");t.b("\n" + i);t.b("</div>");return t.fl(); },partials: {}, subs: {  }});
